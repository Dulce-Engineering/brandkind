class Utils
{
  ...
  static Connect_Store(elem, On_Store_Connected)
  {
    let store_elem = null;
    ...
    if (!Utils.isEmpty(store_id))
    {
      ...
      if (store_elem)
      {
        store_elem.addEventListener("connected", On_Store_Connected);
      }
    }
  ...
  static async Render_Wait_Btn(container_elem, fn)
  {
    container_elem.classList.add("waiting_btn");
    await fn();
    container_elem.classList.remove("waiting_btn");
  }
